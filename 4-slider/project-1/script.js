...
// let slideParent = [...wrapper.children];



// slideParent.slice(3).reverse().forEach((slide)=>{
//     wrapper.insertAdjacentHTML("afterbegin", slide.outerHTML);
//   })

// slideParent.slice(0,4).forEach((slide)=>{
//   wrapper.insertAdjacentHTML("beforeend", slide.outerHTML);
// })
...
//     wrapper.scrollLeft = count * slideWidth;
// }
...
// const repeatAutoPlay = () =>{
//     autoPlay()
// }


// wrapper.addEventListener("mouseover", stopAutoPlay)
// wrapper.addEventListener("mouseleave", repeatAutoPlay)